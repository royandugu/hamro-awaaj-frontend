          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/admin/settings"
                  className={`${pathname === "/admin/settings" ? "bg-graydark" : ""} group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark`}
                >
                  <svg
                    className="fill-current"
                    width="18"
