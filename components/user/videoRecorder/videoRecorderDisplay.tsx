                            ...
                            <>
                                ...
                                <div className="flex justify-center mt-10">
                                    <div className="w-full">
                                        <button type="submit" className={` w-full px-10 flex justify-center ${contextContainer.loading === 0 ? 'py-3' : 'py-5'} bg-[#1c2434] opacity-75 hover:opacity-100 ${contextContainer.loading === 0 && 'opacity-50 pointer-events-none'} text-white rounded`} onClick={() => {
                                            setIsCamOpen(true)
                                        }}> Open webcam </button>
                                    </div>
                                </div>
