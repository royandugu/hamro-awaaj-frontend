...
import SidebarLinkGroup from '../../../components/sidebarLinkGroup/sideBarLinkGroup';
            ...
            <ul className="mb-4 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  ...
                  className={`group relative ${pathname === "/admin/dashboard" ? "bg-graydark" : ""} flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark`}
              ...
              <li>
                <Link
                  href="/admin/users"
                  className={`group ${pathname === "/admin/users" ? "bg-graydark" : ""} relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark`}
                >
                  <svg
                    className="fill-current"
                    width="18"
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <DropDown href="/admin/settings/account">
                              <MdManageAccounts />
                              Account
                            </DropDown>
                            <div className='mt-3' />
                            <DropDown href="/admin/settings/prefrences">
                              <RiFileSettingsLine />
                              Prefrences
                            </DropDown>
                          </li>
